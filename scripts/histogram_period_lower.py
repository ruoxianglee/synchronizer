...
observed_timestamp_list_path = \
            ['evaluation/varied_periods/varied_period_lower_10',
             'evaluation/varied_periods/varied_period_lower_20',
             'evaluation/varied_periods/varied_period_lower_30',
             'evaluation/varied_periods/varied_period_lower_40',
             'evaluation/varied_periods/varied_period_lower_50'
             ]
...
file_list = ['evaluation/varied_periods/varied_period_lower_10/timestamp_lat.txt',
             'evaluation/varied_periods/varied_period_lower_10/timestamp_mdl.txt',
             'evaluation/varied_periods/varied_period_lower_20/timestamp_lat.txt',
             'evaluation/varied_periods/varied_period_lower_20/timestamp_mdl.txt',
             'evaluation/varied_periods/varied_period_lower_30/timestamp_lat.txt',
             'evaluation/varied_periods/varied_period_lower_30/timestamp_mdl.txt',
             'evaluation/varied_periods/varied_period_lower_40/timestamp_lat.txt',
             'evaluation/varied_periods/varied_period_lower_40/timestamp_mdl.txt',
             'evaluation/varied_periods/varied_period_lower_50/timestamp_lat.txt',
             'evaluation/varied_periods/varied_period_lower_50/timestamp_mdl.txt'
             ]

# subed_timestamp_list_path = 'topic6/test3/varied_period_lower_'

labels = ['[10-100]', '[20-100]', '[30-100]', '[40-100]', '[50-100]']
...
# delay_list = [0, 0, 0, 0, 0, 0]
# for j in range(len(labels)):
#     ros_bound, cyber_bound = get_both_bounds(j, ChanNum, delay_list)
#     rt_bound_list.append(cyber_bound)
#     ros_bound_list.append(ros_bound)
...
plt.savefig('his_fig_varied_period_lower', dpi=400)

print("Generate figure (b) successfully. ")